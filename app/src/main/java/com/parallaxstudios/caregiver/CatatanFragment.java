...
import com.parallaxstudios.caregiver.activity.AddActivity;
import com.parallaxstudios.caregiver.activity.DetailActivity;
import com.parallaxstudios.caregiver.adapter.CatatanAdapter;
import com.parallaxstudios.caregiver.model.Catatan;
        ...
        protected void onPostExecute(String result) {
            ...
            if (designTitle.length != 0) {
                for (int i = postNumber - 1; i >= 0; i--) {
                    designs.add(new Catatan(designTitle[i], designExcerpt[i], designImage[i]));
                }
            }
            if (error) {
            ...
            recyclerViewAdapter = new CatatanAdapter(getActivity(), designs);
