...
public class RiwayatKesehatanAdapter extends RecyclerView.Adapter<RiwayatKesehatanAdapter.ViewHolder>{

    private ArrayList<RiwayatKesehatan> berandas;
    Context context;

    // Adapter's Constructor
    public RiwayatKesehatanAdapter(Context context, ArrayList<RiwayatKesehatan> designs) {
    ...
    @Override
    public RiwayatKesehatanAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
