...
public class NotifikasiAndaAdapter extends RecyclerView.Adapter<NotifikasiAndaAdapter.ViewHolder>{

    private ArrayList<NotifikasiAnda> berandas;
    Context context;

    // Adapter's Constructor
    public NotifikasiAndaAdapter(Context context, ArrayList<NotifikasiAnda> designs) {
    ...
    @Override
    public NotifikasiAndaAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
