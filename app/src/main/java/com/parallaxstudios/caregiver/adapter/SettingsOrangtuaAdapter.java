...
public class SettingsOrangtuaAdapter extends RecyclerView.Adapter<SettingsOrangtuaAdapter.ViewHolder>{

    private ArrayList<SettingsOrangtua> berandas;
    Context context;

    // Adapter's Constructor
    public SettingsOrangtuaAdapter(Context context, ArrayList<SettingsOrangtua> designs) {
    ...
    @Override
    public SettingsOrangtuaAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
