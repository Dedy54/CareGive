...
public class NotifikasiOrangtuaAdapter extends RecyclerView.Adapter<NotifikasiOrangtuaAdapter.ViewHolder>{

    private ArrayList<NotifikasiOrangtua> berandas;
    Context context;

    // Adapter's Constructor
    public NotifikasiOrangtuaAdapter(Context context, ArrayList<NotifikasiOrangtua> designs) {
    ...
    @Override
    public NotifikasiOrangtuaAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
