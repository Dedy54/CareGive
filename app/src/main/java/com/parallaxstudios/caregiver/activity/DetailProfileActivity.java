    ...
    public void navigationBarStatusBar() {
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                DetailProfileActivity.this.getTheme().resolveAttribute(R.attr.colorPrimary, typedValue19, true);
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                DetailProfileActivity.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValue21, true);
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                DetailProfileActivity.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValue, true);
