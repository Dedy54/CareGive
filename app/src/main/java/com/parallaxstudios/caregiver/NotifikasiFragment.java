...
import com.parallaxstudios.caregiver.adapter.Viewpager.TabsNotifikasiViewPagerAdapter;
...
public class NotifikasiFragment extends Fragment {
	...
	TabsNotifikasiViewPagerAdapter tabsNotifikasiViewPagerAdapter;
	View view;
	CharSequence titles[] = {"Orang Tua", "Anda"};
	...
	public void setupTabs() {
		tabsNotifikasiViewPagerAdapter = new TabsNotifikasiViewPagerAdapter(getFragmentManager(), titles, tabNumber);
        pager = (ViewPager) view.findViewById(R.id.pager);
        pager.setAdapter(tabsNotifikasiViewPagerAdapter);
