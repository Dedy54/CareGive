...
import com.parallaxstudios.caregiver.activity.ChartActivity;
import com.parallaxstudios.caregiver.adapter.RiwayatKesehatanAdapter;
import com.parallaxstudios.caregiver.model.RiwayatKesehatan;
...
public class Riwayat_KesehatanFragment extends Fragment {
	
	String urlPost;
    JSONObject jsonObjectDesignPosts;
    JSONArray jsonArrayDesignContent;
    ArrayList<RiwayatKesehatan> designs;
	...
	public Riwayat_KesehatanFragment(){}
	
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
 
        view = inflater.inflate(R.layout.fragment_riwayat_kesehatan, container, false);
        ...
        protected void onPostExecute(String result) {
            ...
            if (designTitle.length != 0) {
                for (int i = postNumber - 1; i >= 0; i--) {
                    designs.add(new RiwayatKesehatan(designTitle[i], designExcerpt[i], designImage[i]));
                }
            }
            if (error) {
            ...
            recyclerViewAdapter = new RiwayatKesehatanAdapter(getActivity(), designs);
