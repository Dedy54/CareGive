package com.parallaxstudios.caregiver.tabs.Notifikasi;
...
import com.parallaxstudios.caregiver.adapter.NotifikasiOrangtuaAdapter;
import com.parallaxstudios.caregiver.model.NotifikasiOrangtua;
...
import com.parallaxstudios.caregiver.utill.utill.DividerItemDecoration;
...
public class Notifikasi_Orang_Tua_Fragment extends Fragment {
	
	String urlPost;
    JSONObject jsonObjectDesignPosts;
    JSONArray jsonArrayDesignContent;
    ArrayList<NotifikasiOrangtua> designs;
	...
	public Notifikasi_Orang_Tua_Fragment(){}
	
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
 
        view = inflater.inflate(R.layout.fragment_notifikasi_orang_tua, container, false);
        ...
        protected void onPostExecute(String result) {
            ...
            if (designTitle.length != 0) {
                for (int i = postNumber - 1; i >= 0; i--) {
                    designs.add(new NotifikasiOrangtua(designTitle[i], designExcerpt[i], designImage[i]));
                }
            }
            if (error) {
            ...
            recyclerViewAdapter = new NotifikasiOrangtuaAdapter(getActivity(), designs);
