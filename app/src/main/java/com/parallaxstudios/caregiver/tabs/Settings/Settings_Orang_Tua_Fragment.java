...
import com.parallaxstudios.caregiver.activity.DetailActivity;
import com.parallaxstudios.caregiver.activity.NewElderActivity;
import com.parallaxstudios.caregiver.R;
import com.parallaxstudios.caregiver.adapter.SettingsOrangtuaAdapter;
import com.parallaxstudios.caregiver.model.SettingsOrangtua;
...
public class Settings_Orang_Tua_Fragment extends Fragment {
	
	String urlPost;
    JSONObject jsonObjectDesignPosts;
    JSONArray jsonArrayDesignContent;
    ArrayList<SettingsOrangtua> designs;
	...
	public Settings_Orang_Tua_Fragment(){}
	
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
 
        view = inflater.inflate(R.layout.fragment_settings_orangtua, container, false);
	...
	private void openNewElder(){
		Intent intent = new Intent(getActivity(), NewElderActivity.class);
        ...
        protected void onPostExecute(String result) {
            ...
            if (designTitle.length != 0) {
                for (int i = postNumber - 1; i >= 0; i--) {
                    designs.add(new SettingsOrangtua(designTitle[i], designExcerpt[i], designImage[i]));
                }
            }
            if (error) {
            ...
            recyclerViewAdapter = new SettingsOrangtuaAdapter(getActivity(), designs);
